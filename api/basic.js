...
export async function GET() {
  return NextResponse.json({ ok: true, hasKey: !!process.env.RESEND_API_KEY });
}
...
export async function POST(req) {
  try {
    ...
    const SameLocation = get("B-Same-Location"); // checkbox
    ...
    const pageUrl = get("Page URL"); // ✅ бо в HTML name="Page URL"
...
- ${color4}
    ...
    console.error("basic API error:", e);
